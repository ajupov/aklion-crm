...
namespace Crm.Controllers.Administration
{
    ...
    public class AdministrationProductAttributeLinksController : BaseController
    {
        private readonly IProductAttributeLinkDao _dao;

        public AdministrationProductAttributeLinksController(IProductAttributeLinkDao dao)
        {
            _dao = dao;
        }
