...
namespace Infrastructure.DateTime
{
    public static class DateTimeExtension
    {
        ...
        public static System.DateTime? ToNullableDate(this string dateString)
        {
            ...
            if (System.DateTime.TryParseExact(dateString, DateFormat, CultureInfo.InvariantCulture, DateTimeStyles.None, out var outDate))
            {
                return outDate;
            }
        ...
        public static System.DateTime? ToNullableDateTime(this string dateTimeString)
        {
            ...
            if (System.DateTime.TryParseExact(dateTimeString, DateTimeFormat, CultureInfo.InvariantCulture, DateTimeStyles.None, out var outDateTime))
            {
                return outDateTime;
            }
