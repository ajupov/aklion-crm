...
namespace Infrastructure.Dao
{
    public class Dao : IDao
    {
        ...
        public Task<(int TotalCount, List<TModel> List)> GetPagedListAsync<TModel, TParameter>(TParameter parameter, bool distinct = false)
        {
        ...
        public Task<Dictionary<string, int>> GetForAutoCompleteAsync<TModel, TParameter>(TParameter parameter, bool distinct = false)
        {
            var query = QueryBuilder
        ...
        public Task<Dictionary<string, int>> GetForSelectAsync<TModel, TParameter>(TParameter parameter, bool distinct = false)
        {
            var query = QueryBuilder
                .Create<TModel>(QueryType.SelectForAutocompleteOrSelect, distinct)
                .DefineTableName()
