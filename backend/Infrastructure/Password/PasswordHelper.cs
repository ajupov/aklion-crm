...
namespace Infrastructure.Password
{
    public static class PasswordHelper
    {
        ...
        {
            var salt = GetSalt();
            var bytes = GetBytes(password, salt);
        ...
        public static bool Verify(string password, string hashedPassword)
        {
            ...
            return IsEqual(KeyDerivation.Pbkdf2(password, salt, KeyDerivationPrf.HMACSHA512, IterationsCount, HashLength - SaltLength - 1), array);
        }
        ...
        {
            return KeyDerivation.Pbkdf2(password, salt, KeyDerivationPrf.HMACSHA512, IterationsCount, HashLength - SaltLength - 1);
        }
