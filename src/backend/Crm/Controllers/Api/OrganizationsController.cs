...
//using Crm.ApiV1.Mappers;
//using Crm.ApiV1.Models;
//using Crm.Dao.Organization;
//using Microsoft.AspNetCore.Mvc;

//namespace Crm.ApiV1.Controllers
//{
...
//model1.Name = $"���� � ������ {DateTime.Now.ToString(CultureInfo.InvariantCulture)}";
//await _apiClient.PutAsync("organizations", model1).ConfigureAwait(false);

//model1.Name = $"���� � ������ 2 {DateTime.Now.ToString(CultureInfo.InvariantCulture)}";
