...
$(document).ready(() => {
    createTable({
        ...
        Columns: [
            ...
            { Name: 'Email', Label: 'Электронный адрес', Type: 'text', Width: 130, Editable: true, MaxLength: 256 },
            ...
            { Name: 'Gender', Label: 'Пол', Type: 'select', SelectValues: '0:;1:Мужской;2:Женский', Width: 80, Editable: true},
            { Name: 'BirthDate', Label: 'Дата рождения', Type: 'date', Width: 100, Editable: true },
            { Name: 'IsEmailConfirmed', Label: 'Email подтвержден', Type: 'checkbox', Hidden: true, Editable: true, EditHidden: true },
            { Name: 'IsPhoneConfirmed', Label: 'Телефон подтвержден', Type: 'checkbox', Hidden: true, Editable: true, EditHidden: true },
